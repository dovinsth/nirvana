			...
			if( $slAr > 0 ){
                ...
                foreach( $slideno as $sln ){ ?>
                    ...
                    <div class="slide_info">
                           ...
                           <p><?php echo get_theme_mod('slide_desc'.$sln, __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pulvinar nibh purus, eget convallis erat efficitur eget.','clovemix')); ?></p>
                    </div>                           
                        <p class="slide_more"><a href="<?php echo esc_url(get_theme_mod('slide_link'.$sln, '#'.$sln)); ?>"><?php _e('Read More','clovemix'); ?></a></p>
                    </div><?php } ?>
