...
amet justo tincidunt vehicula eros a dictum nunc Phasellus aliquet ex nec mauris commodo
	...
	#here
	$options[] = array(
		'name' => __('Slider Image 4', 'skt-biz'),
		'desc' => __('Upload / select image for slide 4', 'skt-biz'),
		'id' => 'slide4',
		'class' => '',
		'std' => get_template_directory_uri()."/images/slides/slide4.jpg",
		'type' => 'upload');

	$options[] = array(
		'desc' => __('Title 4', 'skt-biz'),
		'id' => 'slidetitle4',
		'std' => 'Easy to Use',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Slide Descrition 4', 'skt-biz'),
		'id' => 'slidedesc4',
		'std' => 'Nulla nunc purus, interdum quis imperdiet in, placerat id felis. Duis sodales iaculis mauris. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut leo augue, posuere id commodo quis, malesuada in justo.',
		'type' => 'textarea');			
		
	$options[] = array(
		'desc' => __('Link / Url 4', 'skt-biz'),
		'id' => 'slideurl4',
		'std' => '#link4',
		'type' => 'text',
		'subtype' => 'url');
